...
export default function CreateFolderModal(props) {
  ...
  return (
    <div className="fixed left-0 top-0 z-50 flex h-screen w-screen items-center justify-center bg-overlay text-text">
      <div className="relative flex w-[300px] flex-col items-center justify-center rounded-base border-2 border-border bg-bg p-10 pt-12 font-base shadow-base">
        <button
        ...
        <div className="mt-2 grid grid-rows-[2em,1fr]">
        ...
        <button
          className="text-align-center w-18 ml-2 mt-8 flex cursor-pointer rounded-base border-2 border-black bg-main px-4 py-2 text-sm font-base shadow-base transition-all hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none"
